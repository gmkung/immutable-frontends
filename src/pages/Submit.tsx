      ...
      <Container className="text-center mb-12 animate-slide-down">
        <div className="flex items-center justify-center mb-6">
          <Button
            variant="ghost"
            onClick={() => navigate("/")}
            className="absolute left-4 md:left-8 md:top-24 px-2 md:px-4 flex items-center text-hawaii-blue hover:text-hawaii-blue/80 bg-hawaii-blue/10 md:bg-transparent hover:bg-hawaii-blue/10"
          >
        ...
        <p className="max-w-2xl mx-auto text-muted-foreground backdrop-blur-sm bg-white/30 p-4 rounded-xl border border-white/20">
          Submit a new frontend to the registry. Your submission will be stored
          on IPFS and added to the blockchain registry.
        </p>
      </Container>
